package com.npisistemas.brewer.controller.page;
...
public class PageWrapper<T> {
	...
	public PageWrapper(Page<T> page, HttpServletRequest httpServletRequest) {
		...
		//Gambiarra pra resolver bug da pesquisa com filtro
	...
	//Funcao pra inverter direção da setinha de ordenação
	public boolean descendente(String propriedade) {
		return inverterDirecao(propriedade).equals("asc");
	}
	
	//Verificar se a página já possui ordenação
