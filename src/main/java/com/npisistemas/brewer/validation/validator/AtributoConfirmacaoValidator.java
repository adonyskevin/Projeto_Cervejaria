package com.npisistemas.brewer.validation.validator;
...
import com.npisistemas.brewer.validation.AtributoConfirmacao;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object>{
	...
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		try{
			...
			valido = valoresNull(valorAtributo, valorAtributoConfirmacao) || valoresIguais(valorAtributo, valorAtributoConfirmacao);
		}catch (Exception e){
	...
	private boolean valoresNull(Object valorAtributo, Object valorAtributoConfirmacao) {
