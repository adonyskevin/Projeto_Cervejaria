...
Brewer.EstiloCadastroRapido = (function(){
	...
	function EstiloCadastroRapido(){
		...
		this.botaoSalvar = this.modal.find('.js-modal-cadastro-estilo-salvar');
	...
	EstiloCadastroRapido.prototype.iniciar = function(){
		...
		//Evento lançado quando o modal é carregado
		this.modal.on('shown.bs.modal', onModalShow.bind(this));
		
		//Evento lançado quando o modal é fechado
	...
	function onBotaoSalvarClick(){
		nomeEstilo = this.inputNomeEstilo.val().trim();
		$.ajax({
			url: this.url,
			method: 'POST',
			...
			success: onSucessoSalvarEstilo.bind(this)
		});
	}
	...
	function onSucessoSalvarEstilo(estilo){
